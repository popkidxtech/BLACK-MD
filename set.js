...
module.exports = { session: process.env.SESSION_ID || 'POPKID-MD',
    ...
    OWNER_NAME : process.env.OWNER_NAME || "Popkid254",
    ...
    URL: process.env.URL || "https://files.catbox.moe/nk71o3.jpg",  
    ...
    CAPTION : process.env.CAPTION || "POPKID-MD",
    BOT : process.env.BOT_NAME || '𝗣𝗢𝗣𝗞𝗜𝗗-𝗠𝗗',
